...
- [ ] Lock files (package-lock.json, yarn.lock, or pnpm-lock.yaml) present and up to date
- [ ] Platform-specific dependencies handled correctly
- [ ] Development vs. production dependencies properly separated (devDependencies vs dependencies)
- [ ] License compatibility checked and documented
- [ ] No duplicate dependencies
- [ ] Semantic versioning followed (^, ~, or exact versions used appropriately)
- [ ] CI/CD environment matches development environment
- [ ] TypeScript type definitions (@types packages) included where needed
- [ ] Peer dependencies properly declared and compatible
...
Locations:
- package.json:42: [brief description]
...
**Feedback**:
🟠 MAJOR: Loose version constraint - react="*" allows incompatible versions
